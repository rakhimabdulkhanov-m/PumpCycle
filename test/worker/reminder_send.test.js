...
describe('the double-send guard', () => {
  ...
  it('treats a new cycle as a new reminder', async () => {
    // After a pumping, cycle_seq advances and the customer is legitimately due
    // again. The guard must not suppress that forever.
