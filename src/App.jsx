...
import { updateCustomerState } from './lib/customers.js'
...
function App() {
  ...
  // The rules this applies - one customer touched, cycle resets, and the
  // address-changed stamp - live in src/lib/customers.js, where they can be
  // tested as themselves. App only decides when to persist.
  function updateCustomer(id, patch) {
    persist(updateCustomerState(data, id, patch))
  }
